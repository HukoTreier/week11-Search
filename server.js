...
const app = express(); // initsialiseerime appi
app.set('view engine', 'ejs'); // täpsustab saatmiseks view enginet (ejs)
app.use(express.static('public')); // lubab serveril kasutada public kausta faili (css) saatmiseks
...
app.listen(process.env.PORT || 3000, () => { // app ootab päringut portil 3000  process.env.PORT vajalik serverile, et avaldada leht (vabadus valida enda port)
